...
$administrator->idCoproperty = isset($_GET['idCoproperty']) ? $_GET['idCoproperty'] : die();
array_push($person->administrators, $administrator);

// query persons
$stmt = $person->readAdministratorsByCopro();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        array_push($person_item["administrators"],$administrator);
